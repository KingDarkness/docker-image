...
RUN apt-get update && apt-get install -y nginx libfreetype6-dev libjpeg62-turbo-dev zlib1g-dev libpng-dev libpq-dev libzip-dev libicu-dev libgmp-dev libwebp-dev \
    libmcrypt-dev \
    uuid-dev \
    zip curl \
